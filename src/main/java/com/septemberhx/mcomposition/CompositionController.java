...
public class CompositionController extends MObject {
    ...
    @MFunctionType
com.sampleservice.gaodeservice.controller.MainController controller0;
@MFunctionType
com.sampleservice.wechatservice.controller.MainController controller1;
    ...
    public MResponse test(@RequestBody MResponse body) {
        MResponse r0 = controller0.navigationFunction(body);
