...
public class CompositionController extends MObject {
    ...
    @MFunctionType
com.sampleservice.tencentservice.controller.MainController controller0;
@MFunctionType
com.sampleservice.bilibiliservice.controller.MainController controller1;


    @RequestMapping(path = "/test", method = RequestMethod.POST)
    @MApiFunction
    public MResponse test(@RequestBody MResponse body) {
        MResponse r0 = controller0.gameFunction(body);
MResponse r1 = controller1.streamFunction(r0);
return r1;
