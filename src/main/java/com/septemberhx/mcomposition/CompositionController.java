...
public class CompositionController extends MObject {
    ...
    @MFunctionType
com.sampleservice.paypalservice.controller.MainController controller0;
@MFunctionType
com.sampleservice.shunfengservice.controller.MainController controller1;


    @RequestMapping(path = "/test", method = RequestMethod.POST)
    @MApiFunction
    public MResponse test(@RequestBody MResponse body) {
        MResponse r0 = controller0.payFunction(body);
