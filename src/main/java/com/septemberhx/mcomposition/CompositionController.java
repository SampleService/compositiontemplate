...
public class CompositionController extends MObject {
    ...
    @MFunctionType
com.sampleservice.meituanservice.controller.MainController controller0;
@MFunctionType
com.sampleservice.didiservice.controller.MainController controller1;
    ...
    public MResponse test(@RequestBody MResponse body) {
        MResponse r0 = controller0.canteenFunction(body);
MResponse r1 = controller1.carFunction(r0);
return r1;
