...
public class CompositionController extends MObject {
    ...
    @MFunctionType
com.sampleservice.jindongservice.controller.MainController controller0;
@MFunctionType
com.sampleservice.amazonservice.controller.MainController controller1;
    ...
    public MResponse test(@RequestBody MResponse body) {
        MResponse r0 = controller0.deliveryFunction(body);
MResponse r1 = controller1.marketFunction(r0);
return r1;
